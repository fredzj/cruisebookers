...
class AffiliateCruiseship extends Model
{
    ...
    protected $fillable = [
        ...
        'number_of_rooms',
        'paragraph_destinations',
        'paragraph_family_kids',
        'paragraph_fitness_relaxation',
        'paragraph_entertainment_leisure',
        'paragraph_huts_suites',
        'paragraph_restaurants_buffet',
        'paragraph_decks',
        'paragraph_bars_lounges',
        'slug',
        'stars',
        'type',
        'year_built',
